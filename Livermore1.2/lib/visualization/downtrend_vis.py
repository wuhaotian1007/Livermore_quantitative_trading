...
conn = sqlite3.connect(
    'C:/Users/sgnjim/Desktop/for_python/Livermore1.2/database/XAUUSD_DXY_TNX.db')
c = conn.cursor()
...
for data in data_list:
    ...
    if NAME == "comb":
        ...
        if c.fetchall():
            ...
            sheet.write(row, 26, content, style_def)

# 保存文件
xl.save('C:/Users/sgnjim/Desktop/for_python/Livermore1.2/report/XAUUSD-DXY-TNX-{0}-downtrend.xls'.format(
    time.strftime("%Y-%m-%d")))
xl.save('C:\\Users\\sgnjim\\OneDrive\\work\\Livermore_report\\archive\\XAUUSD-DXY-TNX-{0}-start_with_downtrend0-with_trend_signal.xls'.format(
    time.strftime("%Y-%m-%d")))
xl.save('C:\\Users\\sgnjim\\OneDrive\\work\\Livermore_report\\latest_report\\XAUUSD-DXY-TNX-lateststart_with_downtrend0-with_trend_signal.xls')