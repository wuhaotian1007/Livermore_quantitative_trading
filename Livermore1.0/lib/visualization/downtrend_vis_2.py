...
conn = sqlite3.connect(
    'C:\\Users\\sgnjim\\Desktop\\for_python\\Livermore1.0\\database\\XAUUSD_DXY.db')
c = conn.cursor()
...
# 保存文件
xl.save('C:\\Users\\sgnjim\\Desktop\\for_python\\Livermore1.0\\report\\XAUUSD-DXY-{0}-downtrend.xls'.format(
    time.strftime("%Y-%m-%d")))
xl.save('C:\\Users\\sgnjim\\OneDrive\\work\\Livermore_report\\archive\\XAUUSD-DXY-{0}-downtrend.xls'.format(
    time.strftime("%Y-%m-%d")))
xl.save('C:\\Users\\sgnjim\\OneDrive\\work\\Livermore_report\\latest_report\\XAUUSD-DXY-latest-downtrend.xls')
