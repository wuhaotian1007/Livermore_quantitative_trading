...
conn = sqlite3.connect(
    'C:\\Users\\sgnjim\\Desktop\\for_python\\Livermore1.0\\database\\USDCAD_DXY_TNX.db')
c = conn.cursor()
...
# 保存文件
xl.save('C:\\Users\\sgnjim\\Desktop\\for_python\\Livermore1.0\\report\\USDCAD-DXY-TNX-{0}-downtrend.xls'.format(
    time.strftime("%Y-%m-%d")))
xl.save('C:\\Users\\sgnjim\\OneDrive\\work\\Livermore_report\\archive\\USDCAD-DXY-TNX-{0}-downtrend.xls'.format(
    time.strftime("%Y-%m-%d")))
xl.save('C:\\Users\\sgnjim\\OneDrive\\work\\Livermore_report\\latest_report\\USDCAD-DXY-TNX-latest-downtrend.xls')
