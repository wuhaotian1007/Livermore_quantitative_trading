...
conn = sqlite3.connect(
    'C:/Users/sgnjim/Desktop/for_python/Livermore1.3/database/XAUUSD_TNX.db')
c = conn.cursor()
...
# 保存文件
xl.save('C:/Users/sgnjim/Desktop/for_python/Livermore1.3/report/XAUUSD-TNX-{0}-downtrend.xls'.format(
    time.strftime("%Y-%m-%d")))
